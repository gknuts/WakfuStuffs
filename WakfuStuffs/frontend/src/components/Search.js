...
const Search = ({stuffs, actions, page, total, size_page, myFilter}) => {
    return(
        <div className="wrap">
            <div className="fleft">
                <Page page={page} size_page={size_page} actions={actions} total={total}/>
                <DisplayStuffs stuffs={stuffs} actions={actions} page={page} size_page={size_page} total={total} myFilter={myFilter}/>
                <Page page={page} size_page={size_page} actions={actions} total={total}/>
            </div>
